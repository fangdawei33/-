...
// 保存所有用户数据并返回操作结果（成功/失败）
int saveAllUsers();

// 保存所有管理员数据并返回操作结果（成功/失败）
int saveAllAdmins();

// 同时保存所有用户和管理员数据，并返回操作结果（成功/失败）
int saveAll();

// 注册用户（参数 isAdmin 指示是否为管理员）
void registerUser(int isAdmin);

// 用户登录（参数 isAdmin 指示是否为管理员）
...
// 生词本
void addToShengciBen(const char *english, const char *chinese); // 将单词加入生词本
